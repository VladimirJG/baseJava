                        ...
                        <div class="section-wrapper">
                            <c:choose>
                                <c:when test="${empty company.homePage.url}">
                                    <div class="job-name">${company.homePage.name}</div>
                                </c:when>
                                <c:otherwise>
                                    <div class="job-name"><a class="contact-link"
                                                             href="${company.homePage.url}">${company.homePage.name}</a>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                            <c:forEach var="position" items="${company.positions}">
                                <jsp:useBean id="position" type="com.basejava.webapp.model.Company.Position"/>
